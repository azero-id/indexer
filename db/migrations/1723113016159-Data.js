module.exports = class Data1723113016159 {
    name = 'Data1723113016159'
    ...
    async up(db) {
        ...
        await db.query(`CREATE TABLE "domain" ("id" character varying NOT NULL, "tld" text NOT NULL, "name" text NOT NULL, "registered_at" TIMESTAMP WITH TIME ZONE NOT NULL, "expires_at" TIMESTAMP WITH TIME ZONE, "owner_id" character varying, CONSTRAINT "PK_27e3ec3ea0ae02c8c5bceab3ba9" PRIMARY KEY ("id"))`)
        ...
        await db.query(`CREATE TABLE "received_fee" ("id" character varying NOT NULL, "block_hash" text NOT NULL, "tld" text NOT NULL, "name" text NOT NULL, "from" text NOT NULL, "event_type" text NOT NULL, "received_at" TIMESTAMP WITH TIME ZONE NOT NULL, "received_amount" numeric NOT NULL, "received_amount_eur" numeric NOT NULL, "registration_duration_in_years" integer NOT NULL, CONSTRAINT "PK_75fa7cead141f6ccb9be0cd9a5f" PRIMARY KEY ("id"))`)
        await db.query(`CREATE INDEX "IDX_7a0952f14bc3b64c069fa73e23" ON "received_fee" ("block_hash") `)
        await db.query(`CREATE INDEX "IDX_a1d239e9fce915c248e1743cdf" ON "received_fee" ("tld") `)
    ...
    async down(db) {
        ...
        await db.query(`DROP INDEX "public"."IDX_a1d239e9fce915c248e1743cdf"`)
